package com.java.os.api.service;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.java.os.api.common.Payment;
import com.java.os.api.repository.OrderRepository;
...
/*    @Value("${microservice.payment-service.endpoints.endpoint.uri}")
    ...
    public Order findByOrderId(int orderId) throws JsonProcessingException {
        Order order = repository.findByOrderId(orderId);
    //    logger.info("orderService findByOrderId : {}",new ObjectMapper().writeValueAsString(order));
        return order ;
    }
